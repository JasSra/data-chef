...
const KEYWORD_MAP: [RegExp, BrandMatch][] = [
  ...
  [/postgres/i,     { faClass: 'fa-solid fa-database',           color: 'text-blue-400' }],
  [/mysql|maria/i,  { faClass: 'fa-solid fa-database',           color: 'text-orange-400' }],
  [/mongo/i,        { faClass: 'fa-solid fa-leaf',               color: 'text-emerald-400' }],
  [/redis/i,        { faClass: 'fa-solid fa-bolt',               color: 'text-rose-400' }],
  [/elastic/i,      { faClass: 'fa-solid fa-magnifying-glass',   color: 'text-teal-400' }],
...
export const CONNECTOR_BRAND_ICONS: Record<string, BrandMatch> = {
  postgresql:    { faClass: 'fa-solid fa-database',           color: 'text-blue-400' },
  mysql:         { faClass: 'fa-solid fa-database',           color: 'text-orange-400' },
  mongodb:       { faClass: 'fa-solid fa-leaf',               color: 'text-emerald-400' },
  redis:         { faClass: 'fa-solid fa-bolt',               color: 'text-rose-400' },
