...
export default function SetupWizard() {
  ...
  const [companyName, setCompanyName] = useState(settings?.workspace.companyName ?? 'ThreatCo')
  const [workspaceName, setWorkspaceName] = useState(settings?.workspace.workspaceName ?? 'threatco')
  ...
  const [ownerEmail, setOwnerEmail] = useState(settings?.owner.email ?? 'owner@threatco.io')
